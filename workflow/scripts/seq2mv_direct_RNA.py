...
plot_signal_plus_seq(rev_seq2mv, read_ids = args.readID, pos = args.pos, pos_read = pos_read, range = args.range, sequencer = args.sequencer, full_read=False, pod5_dir = args.pod5_dir)
