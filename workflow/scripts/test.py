...
#
        ...
        for i, [start, stop, rev_pos] in enumerate(seq2mv):
            ...
            if x_coord < start_pos:
                ...
                # for ref_seq:
                ax.annotate("Reference sequence:", xy = (-0.05, -0.08), xycoords=("axes fraction", "axes fraction"), ha = "center", color = "grey")
                ax.annotate(aln_pairs[rev_pos-1, 2], xy = (x_coord, -0.08), fontsize = 8, xycoords=("data", "axes fraction"), ha = "center", color = "grey")
                # read seq
